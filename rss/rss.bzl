...
def rss_dependencies():
    # bark only uses ad_rss_lib, spdlog and map_support
    _maybe(
    http_archive,
    name = "ad_rss_lib",
    build_file = "@com_github_rules_rss//rss:rss.BUILD",
    ...
    http_archive,
    name = "spdlog",
    build_file = "@com_github_rules_rss//rss:spdlog.BUILD",
    ...
    http_archive,
    name = "pugixml",
    build_file = "@com_github_rules_rss//rss:pugixml.BUILD",
    ...
    http_archive,
    name = "proj",
    build_file = "@com_github_rules_rss//rss:proj.BUILD",
